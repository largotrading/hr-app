	...
	<div class="row ">
       <div class="col-md-3">
       		<div class="container-fluid text-center well"> 
       			<a class="text-primary" href ="staff_approvel.php">Back to New Staff Approvel </a> <br> <br>

        	</div>
       </div> 
       <div class="col-md-6">
            <div class="container-fluid  well"> 
            	<form class="submit" action="staff_approvel.php" method="post">
	            	...
	            	<button type="submit" class="btn btn-success  btn-lg" name="approved"  value="<?php echo ("$forapprovel"); ?> ">Approved </button>
	            	<button type="submit" class="btn btn-danger  btn-lg" name="approved"  value="<?php echo ("$fordelete"); ?> ">Delete </button>
